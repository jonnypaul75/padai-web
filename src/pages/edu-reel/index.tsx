...
const EduReel = () => {
    ...
    // Observe visibility and control playback
    useEffect(() => {
    ...
    useEffect(() => {
        ...
        // Show title on first load, then fade out after 2s
        setShowTitle(true);
    ...
    useEffect(() => {
        ...
        const handleWheel = (e: WheelEvent) => {
            ...
            scrollTimeoutRef.current = setTimeout(() => {
                ...
                setShowTitle(false); // this will remove `.hidden` class after delay
            }, 2000);
        };
            ...
            <div className="main-container">
                ...
                <div className="shorts-container content-card d-flex justify-content-center" >
                    <div style={{ width: "520px", textAlign: "center" }}>
                        ...
                        <div className={`fixed-title ${showTitle ? "" : "hidden"}`}>
